...
const OrganicQuiz = () => {
  ...
  const questions = [
    {
      id: 'q1',
      question: 'What is the ideal ratio of brown to green materials in composting?',
      type: 'single',
      options: ['1:1', '3:1', '1:3'],
      answer: '3:1',
      explanation: 'A 3:1 ratio of brown (carbon-rich) to green (nitrogen-rich) materials ensures proper decomposition.',
    },
    {
      id: 'q2',
      question: 'Which materials are suitable for composting?',
      type: 'multiple',
      options: ['Vegetable peels', 'Plastic wrappers', 'Grass clippings', 'Batteries'],
      answer: ['Vegetable peels', 'Grass clippings'],
      explanation: 'Vegetable peels and grass clippings are compostable, while plastic and batteries are not.',
    },
    {
      id: 'q3',
      question: 'How often should you turn your compost?',
      type: 'single',
      options: ['Daily', 'Every 1-2 weeks', 'Monthly'],
      answer: 'Every 1-2 weeks',
      explanation: 'Turning every 1-2 weeks aerates the compost, promoting decomposition.',
    },
    {
      id: 'q4',
      question: 'What should the moisture level of compost be like?',
      type: 'single',
      options: ['Dry as sand', 'Wet as a wrung-out sponge', 'Soaked like a swamp'],
      answer: 'Wet as a wrung-out sponge',
      explanation: 'The compost should be moist, like a wrung-out sponge, to support microbial activity.',
    },
    {
      id: 'q5',
      question: 'Which items should you avoid adding to compost?',
      type: 'multiple',
      options: ['Fruit scraps', 'Meat scraps', 'Dry leaves', 'Dairy products'],
      answer: ['Meat scraps', 'Dairy products'],
      explanation: 'Meat and dairy can attract pests and cause odors, making them unsuitable for composting.',
    },
  ];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.post(
        ...
        { lessonId: 'organic_quiz', completed: true },
        { withCredentials: true, timeout: 5000 }
      );
