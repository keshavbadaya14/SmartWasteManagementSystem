...
const HazardousQuiz = () => {
  ...
  const questions = [
    {
      id: 'q1',
      question: 'Which items are considered hazardous waste?',
      type: 'multiple',
      options: ['Batteries', 'Paper', 'Paints', 'Food scraps'],
      answer: ['Batteries', 'Paints'],
      explanation: 'Batteries and paints contain toxic substances, making them hazardous, unlike paper or food scraps.',
    },
    {
      id: 'q2',
      question: 'What should you do before disposing of hazardous waste?',
      type: 'single',
      options: ['Mix chemicals', 'Read labels', 'Burn it'],
      answer: 'Read labels',
      explanation: 'Reading labels identifies hazards and disposal instructions.',
    },
    {
      id: 'q3',
      question: 'How should hazardous waste be stored?',
      type: 'single',
      options: ['In open containers', 'In original containers', 'Mixed with recyclables'],
      answer: 'In original containers',
      explanation: 'Original containers ensure safe storage and clear labeling.',
    },
    {
      id: 'q4',
      question: 'Where should you dispose of hazardous waste?',
      type: 'single',
      options: ['Regular trash', 'Compost bin', 'Collection sites'],
      answer: 'Collection sites',
      explanation: 'Hazardous waste requires special collection sites for safe disposal.',
    },
    {
      id: 'q5',
      question: 'Which items can often be recycled at special facilities?',
      type: 'multiple',
      options: ['Electronics', 'Vegetable peels', 'Fluorescent bulbs', 'Cardboard'],
      answer: ['Electronics', 'Fluorescent bulbs'],
      explanation: 'Electronics and fluorescent bulbs can be recycled at designated facilities, unlike vegetable peels or cardboard.',
    },
  ];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.post(
        ...
        { lessonId: 'hazardous_quiz', answers },
      ...
      await axios.post(
        ...
        { lessonId: 'hazardous_quiz', completed: true },
        { withCredentials: true, timeout: 5000 }
      );
